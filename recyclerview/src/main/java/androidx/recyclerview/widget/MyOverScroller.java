...
public class MyOverScroller {
     ...
     * @hide
     */
    public MyOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
        if (interpolator == null) {
            mInterpolator = new MyScroller.ViscousFluidInterpolator();
        } else {
     ...
     * @deprecated Use {@link #MyOverScroller(Context, Interpolator)} instead.
     */
    @Deprecated
    public MyOverScroller(Context context, Interpolator interpolator,
    ...
    static class SplineOverScroller {
        ...
        void startScroll(int start, int distance, int duration) {
            ...
            Log.i(TAG, "startScroll: mFinal "  +mFinal,new Exception());
        ...
        boolean springback(int start, int min, int max) {
            ...
            Log.i(TAG, "springback: mFinal " + mFinal);
            mVelocity = 0;
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            if (mFinal < min) {
                ...
                mFinal = min;
                Log.i(TAG, "fling: mFinal < min mFinal " + mFinal);
            }

            if (mFinal > max) {
                adjustDuration(mStart, mFinal, max);
                Log.i(TAG, "fling: mFinal > max mFinal " + mFinal);
                mFinal = max;
            }
        }
        ...
        private void onEdgeReached() {
            ...
            Log.i(TAG, "onEdgeReached: nFinal " + mFinal);
